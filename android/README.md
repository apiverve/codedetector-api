...
```gradle
dependencies {
    implementation 'com.github.apiverve:codedetector-api:1.1.12'
}
```
...
```java
import com.apiverve.codedetector.CodeDetectorAPIClient;
import com.apiverve.codedetector.APIResponse;
import com.apiverve.codedetector.APIException;

// Initialize the client
CodeDetectorAPIClient client = new CodeDetectorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/codedetector](https://docs.apiverve.com/ref/codedetector)
...
- **Documentation:** [https://docs.apiverve.com/ref/codedetector](https://docs.apiverve.com/ref/codedetector)
- **Issues:** [GitHub Issues](https://github.com/apiverve/codedetector-api/issues)
