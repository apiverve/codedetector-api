# Code Detector API - Examples

This folder contains example code for using the Code Detector API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/codedetector',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/codedetector");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/codedetector](https://docs.apiverve.com/ref/codedetector)
