...
namespace APIVerve\Codedetector;
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/codedetector?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/codedetector';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CodedetectorClient] {$message}\n";
        }
    }
}
