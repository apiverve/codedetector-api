...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/codedetector',
        'Source': 'https://github.com/apiverve/codedetector-api',
        'Bug Tracker': 'https://github.com/apiverve/codedetector-api/issues'
    },
    classifiers=[
